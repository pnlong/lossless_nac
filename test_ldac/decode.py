...
# Decoder script for Lossless Descript Audio Codec (LDAC).
...
# verbatim
def entropy_decode_verbatim(data):
    return data
...
# naive rice
def entropy_decode_naive_rice(data):
    return data
...
# adaptive rice
def entropy_decode_adaptive_rice(data):
    return data

##################################################


# NAIVE DAC LOSSLESS COMPRESSOR DECODE
##################################################
...
# ADAPTIVE DAC LOSSLESS COMPRESSOR DECODE
##################################################
